        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="TikTok">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/luxury" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Rudy Luxury
                </Link>
              </li>
              <li>
                <Link href="/crocs" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Slide & Sole
                </Link>
              </li>
              <li>
