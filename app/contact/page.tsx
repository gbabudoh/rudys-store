                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm whitespace-pre-line">
                          {settings?.store_email || 'info@ruddysstore.com'}
                ...
                <div className="bg-white rounded-lg shadow-lg p-6">
                  ...
                  <div className="flex flex-wrap gap-4">
                    {settings?.social_facebook && (
                      <a href={settings.social_facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center transition-colors hover:bg-[#cfa224] bg-stone-100 cursor-pointer">
                        <svg className="w-5 h-5 text-stone-600 hover:text-white cursor-pointer" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                        </svg>
                      </a>
                    )}
                    {settings?.social_instagram && (
                      <a href={settings.social_instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center transition-colors hover:bg-[#cfa224] bg-stone-100 cursor-pointer">
                        <svg className="w-5 h-5 text-stone-600 hover:text-white cursor-pointer" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {settings?.social_twitter && (
                      <a href={settings.social_twitter} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center transition-colors hover:bg-[#cfa224] bg-stone-100 cursor-pointer">
                        <svg className="w-5 h-5 text-stone-600 hover:text-white cursor-pointer" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        style={{ '--tw-ring-color': '#cfa224' } as React.CSSProperties & { '--tw-ring-color': string }}
                      />
                      <label htmlFor="privacy" className="ml-2 text-sm text-gray-600 cursor-pointer">
                        I agree to the <Link href="/privacy" className="underline cursor-pointer" style={{ color: '#cfa224' }}>Privacy Policy</Link> and <Link href="/terms" className="underline cursor-pointer" style={{ color: '#cfa224' }}>Terms of Service</Link>
                      </label>
                    </div>
                    ...
                    <button
                      ...
                      className="w-full px-6 py-3 rounded-lg font-semibold text-white transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
