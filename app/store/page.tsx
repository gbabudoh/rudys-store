...
export default function CollectionsPage() {
  ...
  const fetchProducts = useCallback(async () => {
    try {
      ...
      const response = await fetch("/api/products?store_section=collections");
      if (response.ok) {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-gray-50 via-[#201d1e]/5 to-[#cfa224]/5"
    ...
    >
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              Discover our premium fashion collection featuring the latest
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          >
            <div
              className="bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border p-6"
              style={{ borderColor: "#cfa224" }}
            >
              <div
                className="flex items-center justify-between mb-6 pb-4 border-b"
                style={{ borderColor: "#cfa224" }}
              >
                <h3 className="text-lg font-bold" style={{ color: "#201d1e" }}>
                  Filters
                </h3>
          ...
          <div className="lg:w-3/4">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 space-y-4 sm:space-y-0">
              <div className="flex items-center space-x-4">
                ...
                <p className="text-gray-700 font-medium">
                  Showing{" "}
                  <span className="font-bold" style={{ color: "#cfa224" }}>
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  <button
                    ...
                    style={
                      viewMode === "grid" ? { backgroundColor: "#cfa224" } : {}
                    }
                  >
                  ...
                  <button
                    ...
                    style={
                      viewMode === "list" ? { backgroundColor: "#cfa224" } : {}
                    }
                  >
            ...
            {loadingProducts ? (
              ...
              <div className="text-center py-20 bg-white/50 backdrop-blur-sm rounded-2xl border border-dashed border-gray-300">
                ...
                <h3 className="text-xl font-semibold text-[#201d1e]">
                ...
                <button
                  onClick={() => {
                    ...
                    setSelectedSizes([]);
                    setSelectedSubcategories([]);
                    setPriceRange([0, 1000000]); // Updated reset value
                  }}
